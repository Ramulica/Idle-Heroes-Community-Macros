...
Macros for farming **hammers** and upgrading **fort tech** in Fantasy Factory Fort Defense.
...
| Goal | Macro |
|------|--------|
| **Hammers only** — you spend them yourself | `Farm Fort Tech.json` |
| **Hammers + auto-upgrade** fort tech | `Full Fort Tech Farm.json` |
| **Whole factory** — fort hammers **and** Flora workshop | `Full Fantasy Arcade Farm.json` |

### Trial Mode 1 (hammer income)
...
Follow the **[import tutorial in the main README](../../README.md#-how-to-import-macros--controls)**.

**Navigation:** use [`Fantasy Factory - Fort Defens`](../../MoveFromAToB/Fantasy%20Factory%20-%20Fort%20Defens.json) from the main map if you are not already on the Fort Defense screen.
