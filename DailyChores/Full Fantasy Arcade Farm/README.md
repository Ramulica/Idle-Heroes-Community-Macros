...
This is the same **merge pattern** shown in the [Daily Chores merge guide](../#step-3--order-name-and-merge): enter factory → fort farm → go back → workshop actions → go back out.

## Fort Defense / hammers

See the full guide: **[Fort Tech Farm README](../../FantasyFactory/FantasyFactory_FortTechFarm/)**
...
1. Read **[Flora’s Adventure README](../../FantasyFactory/FantasyFactory_FlorasAdventure/)** — especially **board setup**, **first three rows**, and **Main House** corner placement.
