...
| Macro | Control | Role |
|-------|---------|------|
| `fort defens.json` | `FortDefens.cfg` | Fort Defense battles |
| `Farm Fort Tech.json` | — | Farm fort tech nodes |
| `Fort Tech Upgrade.json` | — | Upgrade fort tech |
| `Fort Tech Upgrade 19.json` | — | Level-19 upgrade path |
| `Full Fort Tech Farm.json` | — | Merged fort tech farm |
